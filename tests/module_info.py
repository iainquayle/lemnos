...
from src.kontrol.module_info import ModuleInfo, BasicConvInfo, IdentityInfo, Index, Bound
...
class TestBuild(unittest.TestCase):
	...
	def test_basic_conv_1d(self):
		base_info = ModuleInfo([Bound(1, 10), Bound(1, 10), Bound(1, 10),], Bound(1.0, 2.0), [nn.ReLU()])
		info = BasicConvInfo(base_info, 2, kernel_size=(2, 2), stride=(1, 1), dilation=(1, 1), padding=(0, 0))
